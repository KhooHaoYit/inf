...
inline _W* copy_n_out(_R* _R, number_t size, _W* _W) {
	for (++size; --size; *++_W = *++_R) {}
	return _W;
}
//_R and _W should be at (First item), return _W[size] or (Last item)
template<typename _R, typename number_t, typename _W>
inline _W* copy_n_in(_R* _R, number_t size, _W* _W) {
...
//_R and _W should be at (First item) - 1, return _W[size + 1] or (Last item)
template<typename _R, typename number_t, typename _W>
inline _W* fill_n_out(_W* _W, number_t size, _R _R) {
	for (++size; --size; *++_W = _R) {}
	return _W;
}
//_R and _W should be at (First item), return _W[size] or (Last item)
template<typename _R, typename number_t, typename _W>
inline _W* fill_n_in(_W* _W, number_t size, _R _R) {
